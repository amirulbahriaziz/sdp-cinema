...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtain a bearer token from <code>POST /api/auth/register</code> or <code>POST /api/auth/login</code>, then send it as <code>Authorization: Bearer {token}</code>.',
    ],
